...
namespace HutongGames.PlayMaker.Actions.STYLY
{
    ...
    public interface IHttpRequester : IDisposable
    {
        ...
        void Post(Uri uri, Dictionary<string, string> headers, byte[] body, int timeout, Action<HttpResponse> action);
    ...
    public class HttpRequester : IHttpRequester
    {
        ...
        public void Post(Uri uri, Dictionary<string, string> headers, byte[] body, int timeout, Action<HttpResponse> action)
        {
